...
(function($) {
    ...
    $.googlePlaces = function(element, options) {
        ...
        var defaults = {
              placeId: 'ChIJ-arGh591eS4RRMkxdh3HmL4' // placeId provided by google api documentation
            , render: ['reviews']
            , min_rating: 2
            , max_rows: 2
        ...
        var renderReviews = function(reviews){
          ...
          // html = html+"<p>"+reviews[i].text+"</p><div class='details'><h5>"+name+"</h5><p>"+date+"</p></div>"
